...
class Berita_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('berita_id', $q);
        $this->db->or_like('berita_judul', $q);
        $this->db->or_like('berita_isi', $q);
        $this->db->or_like('berita_tanggal', $q);
        $this->db->or_like('berita_kategori_id', $q);
        $this->db->or_like('berita_gambar', $q);
        $this->db->or_like('berita_pengguna_id', $q);
        $this->db->or_like('berita_slug', $q);
